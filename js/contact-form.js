...
function sendMail(value) {
  Email.send({
    ...
    Username: "olga.cerovic.noroff@gmail.com",
    Password: "00789B7E24FC860922C898174E10C16C526D",
    To: "olga.cerovic.noroff@gmail.com",
    From: "olga.cerovic.noroff@gmail.com",
    Subject: subject.value + " ," + fullName.value,
    Body: message.value + " from " + value,
